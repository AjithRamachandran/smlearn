...
model = LinearRegression(n_iterations=2000)
...
m1 = plt.scatter(100 * X_train[:, 0], y_train, color=cmap(0.9), s=10)
m2 = plt.scatter(100 * X_test[:, 0], y_test, color=cmap(0.5), s=10)
plt.plot(100 * X[:, 0], y_pred_line, color='blue', linewidth=1, label="Prediction")
